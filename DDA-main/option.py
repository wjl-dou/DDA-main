...
parser.add_argument("--save_path", type=str, default="logs/Model", help='path to save models and log files')
parser.add_argument("--save_freq", type=int, default=1, help='save intermediate model')

# For test only
parser.add_argument("--test_data_path", type=str, default="datasets/test", help='path to testing data')
parser.add_argument("--output_path", type=str, default="results/Model11", help='path to save output images')

# For train only
parser.add_argument("--data_path", type=str, default="datasets/train/Rain",
